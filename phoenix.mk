...
# Enhanced NFC (IF THEY HAVE IT, if not then git clone from cyanogenmod)
$(call inherit-product, vendor/phoenix/config/nfc_enhanced.mk)

# Inherit some common Phoenix stuff. (IF THEY HAVE IT, if not then git clone from cyanogenmod)
